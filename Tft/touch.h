...
#define TERMINAL_MAXX (320)///8)        //the maximum display width of the tft in characters
#define TERMINAL_MAXY (240)///12)        //the maximum display height of the tft in characters
